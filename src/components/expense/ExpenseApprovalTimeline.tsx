...
import { approvalBadgeClasses, formatDateTime } from "@/lib/expense-format";
import { EmptyState } from "./EmptyState";
import type { ApprovalRecord, NamedProfile } from "@/lib/expense-detail-types";
...
export const ExpenseApprovalTimeline = ({ approvals, profilesMap }: Props) => (
  <Card>
    <CardHeader>
