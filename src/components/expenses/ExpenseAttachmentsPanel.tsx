...
import { formatDateTime, formatFileSize } from "@/features/expenses/presentation";
import type { NamedProfile, ReceiptRecord } from "@/features/expenses/types";

interface ExpenseAttachmentsPanelProps {
  receipts: ReceiptRecord[];
  profilesMap: Record<string, NamedProfile>;
  onOpenReceipt: (receipt: ReceiptRecord) => void;
}

export function ExpenseAttachmentsPanel({ receipts, profilesMap, onOpenReceipt }: ExpenseAttachmentsPanelProps) {
  return (
    <Card>
      <CardHeader>
