...
import type { NamedProfile, PaymentRecord } from "@/features/expenses/types";

interface ExpensePaymentsPanelProps {
...
export function ExpensePaymentsPanel({
  payments,
  currency,
  profilesMap,
  canManagePayments,
                ...
                <TableBody>
                  {payments.map((payment) => (
                    <TableRow key={payment.id}>
                      ...
                      <TableCell className="font-semibold">{formatAmount(payment.amount, currencySafe(currency))}</TableCell>
                      ...
                      <TableCell className="max-w-xs whitespace-pre-wrap text-sm text-muted-foreground">{payment.notes || "—"}</TableCell>
