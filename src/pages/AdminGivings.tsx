    ...
    <div className="space-y-6">
      <Tabs defaultValue="verification" className="space-y-4">
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          <div>
            <h1 className="text-3xl font-bold">Givings Management</h1>
            <p className="text-sm text-muted-foreground mt-2">
              Keep offline capture and payment verification separate for clearer finance workflows.
            </p>
          </div>
          <TabsList className="grid w-full md:w-auto grid-cols-2">
            <TabsTrigger value="verification">Payment Verification</TabsTrigger>
            <TabsTrigger value="offline">{editingGivingId ? "Edit Offline Giving" : "Record Offline Giving"}</TabsTrigger>
          </TabsList>
        </div>
